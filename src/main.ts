...
import { Engine, Scene, FreeCamera, Camera, Vector3, HemisphericLight, Mesh } from '@babylonjs/core';
...
const objectManager = new ObjectManager(engine, camera, obj1, obj2, obj3)
